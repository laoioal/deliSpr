    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/deli/member/bMulitWriteProc.dlv'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/deli/member/bMulitWriteProc.dlv',	//샘플 URL입니다.
 	        sCallback : '/deli/resources/se2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
