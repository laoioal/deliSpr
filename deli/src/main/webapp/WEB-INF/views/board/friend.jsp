...
<p style="margin-top:-12px">
    ...
    <input type="hidden" class="addre" value="신풍로 77" id="search">
    <input type="hidden" class="address" value="신풍로 78" id="이용현">
    <input type="hidden" class="address" value="신풍로 80" id="이용현1">
</p>
...
for(var i = 0; i < el.length; i++){
	...
	var name = document.getElementsByClassName('address')
