...
for (let i = 0; i < position.length; i ++) {
	...
	var geocoder = new kakao.maps.services.Geocoder();
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch(position[i].address, function(result, status) {
		// 정상적으로 검색이 완료됐으면 
	...
	alert(1);
			...
			// 마커에 표시할 인포윈도우를 생성합니다 
				...
				content: '<div style="width:150px;text-align:center;padding:6px 0;">'+ position[i].text + '</div>' // 인포윈도우에 표시할 내용
	//			content: '<div>' + position[i].text + '</div>'
			});
